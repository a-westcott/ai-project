try:
    ...
    from voltage_alt.state import State, MOVE, BOOM
    location1 = 'voltage_alt/book1.pkl'
    location2 = 'voltage_alt/book2.pkl'
    location3 = 'voltage_alt/book3.pkl'
    location4 = 'voltage_alt/book4.pkl'
